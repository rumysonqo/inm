...
<script type="text/javascript">
    $(document).ready(function() {
      $("#micro_red").change(function() {
        $("#micro_red option:selected").each(function() {
          micro_red = $('#micro_red').val();
          $.post("<?php echo base_url();?>index.php/ipv2/llena_micro", {
            micro_red : micro_red
          }, function(data) {
            $("#micro").html(data);
    ...
    $(document).ready(function() {
      $("#eess").change(function() {
        $("#eess option:selected").each(function() {
          eess = $('#eess').val();
          $.post("<?php echo base_url();?>index.php/ipv2/llena_eess", {eess : eess}, function(data) {
            $("#eesstab").html(data);
...
<script type="text/javascript">
    $(document).ready(function() {
          $.post("<?php echo base_url();?>index.php/ipv2/llena_red", function(data) {
          ...
          $.post("<?php echo base_url();?>index.php/ipv2/graf_num_micro",function(dat){
            dt=JSON.parse(dat);
            graf5(dt);
          });

          $.post("<?php echo base_url();?>index.php/ipv2/graf_cob_micro",function(dat){
            dt=JSON.parse(dat);
            graf6(dt);
          });

          $.post("<?php echo base_url();?>index.php/ipv2/graf_cob_red",function(dat){
            dt=JSON.parse(dat);
            graf7(dt);
          });
    ...
    $(document).ready(function() {
      $("#micro_red").change(function() {
        $("#micro_red option:selected").each(function() {
          ...
          $.post("http://localhost/inm/index.php/ipv2/graf_num_eess",{micro_red:microred}, function(dat){
            dt=JSON.parse(dat);
            graf1(dt)
          });

          $.post("http://localhost/inm/index.php/ipv2/graf_cob_eess",{micro_red:microred}, function(dat1){
            dt1=JSON.parse(dat1);
            graf2(dt1);
          });

          $.post("http://localhost/inm/index.php/ipv2/graf_num_micro_mes",{micro_red:microred}, function(dat2){
            dt2=JSON.parse(dat2);
            graf4(dt2);
          });
...
<script>
    $(document).ready(function() {
      $("#eess").change(function() {
        $("#eess option:selected").each(function() {
          eess = $('#eess').val();
          $.post("<?php echo base_url();?>index.php/ipv2/graf_num_eess_mes",{eess:eess}, function(dat){
            dt=JSON.parse(dat);
            graf3(dt)
          });
...
<center><h3>Seguimiento de Vacuna IPV Segunda Dosis de Noviembre 2015 a Octubre 2016</h3></center>
