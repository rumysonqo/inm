...
class Penta1 extends CI_Controller
{
     ...
     public function index()
     {
          ...
          $this->load->view('view_penta1',$datos);
     }

     public function data_graf2()
     {
          $options = "";
          if($this->input->post('micro_red'))
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_penta1->datos_micro($micro_red);
               if(!empty($datos))
               {
                    $categoria=array();
                    //$categoria['establecimiento']='eess';
                    $serie1=array();
                    //$serie1['cobertura']='cob';
                    foreach($datos as $dat)
                    {
                         ...
                         $categoria['datos'][]=$dat->nombre;
                         $serie1['datos'][]=($avance * 100) / $dat-> meta;
                    }
                    $resultado=array();
                    array_push($resultado, $categoria);
                    array_push($resultado, $serie1);
     ...
     public function graf_num_eess()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_penta1->num_eess($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
     ...
     public function graf_num_eess_mes()
     {
          ...
          if($this->input->post('eess'))
          {
               ...
               $datos = $this->model_penta1->datos_eess($eess);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
     ...
     public function graf_num_micro_mes()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_penta1->datos_micro_mes($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
   ...
   //PARA GRAFICO DE MICRO RED
     ...
     {
          $datos = $this->model_penta1->datos_micro_num();
          if(!empty($datos))
          {
               echo json_encode($datos);
          }
     ...
     {
          $datos = $this->model_penta1->datos_red_cob();
          if(!empty($datos))
          {
               echo json_encode($datos);
          }
     ...
     public function cob_total_micro()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_penta1->micro_cob_total($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
   ...
   //PARA GRAFICO DE MICRO RED
     ...
     {
          $datos = $this->model_penta1->datos_micro_cob();
          if(!empty($datos))
          {
               echo json_encode($datos);
          }
     ...
     public function graf_cob_eess()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_penta1->cob_eess($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
          ...
          if($this->input->post('micro_red'))
          {
               ...
               if(!empty($datos))
               {
                    ...
                    ?>
                         ...
                         <td align="right"><?=$dat -> set_2015 ?></td>
                         <td align="right"><?=$dat -> oct_2015 ?></td>
     ...
     public function llena_red()
     {
               ...
               if(!empty($datos))
               {
                    ...
                    ?>
                         ...
                         <td><?=$dat -> nombre ?></td>
                         <td align="right"><?=$dat -> meta ?></td>
                         <td align="right"><?=$dat -> set15 ?></td>
                         <td align="right"><?=$dat -> oct15 ?></td>
