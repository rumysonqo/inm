...
class Ipv2 extends CI_Controller
{
     ...
     public function index()
     {
          ...
          $this->load->view('view_ipv2',$datos);
     }
     ...
     public function data_graf1()
     {
          ...
          if($this->input->post('micro_red'))
          {
               ...
               $datos = $this->model_ipv2->datos_micro($micro_red);
               if(!empty($datos))
               {
     ...
     public function graf_num_eess()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_ipv2->num_eess($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
     ...
     public function graf_num_eess_mes()
     {
          ...
          if($this->input->post('eess'))
          {
               ...
               $datos = $this->model_ipv2->datos_eess($eess);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
     ...
     public function graf_num_micro_mes()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_ipv2->datos_micro_mes($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
   ...
   //PARA GRAFICO DE MICRO RED
     ...
     {
          $datos = $this->model_ipv2->datos_micro_num();
          if(!empty($datos))
          {
               echo json_encode($datos);
          }
     ...
     {
          $datos = $this->model_ipv2->datos_red_cob();
          if(!empty($datos))
          {
               echo json_encode($datos);
          }
     ...
     public function cob_total_micro()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_ipv2->micro_cob_total($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
   ...
   //PARA GRAFICO DE MICRO RED
     ...
     {
          $datos = $this->model_ipv2->datos_micro_cob();
          if(!empty($datos))
          {
               echo json_encode($datos);
          }
     ...
     public function graf_cob_eess()
     {
          ...
          {
               $micro_red = $this->input->post('micro_red');
               $datos = $this->model_ipv2->cob_eess($micro_red);
               if(!empty($datos))
               {
                    echo json_encode($datos);
               }
